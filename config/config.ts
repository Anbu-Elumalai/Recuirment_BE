...
export async function loadConfig(): Promise<Configuration> {
  _config = {
    ...
    DodoUrl: getEnvOrError('DODO_AXIOS_URL'),
    DodoApiKey: getEnvOrError('DODO_API_KEY'),
    redirectUrl:getEnvOrError('REDIRECT_SUCCESS_URL'),
    CancelUrl:getEnvOrError('CANCEL_URL'),
    WebHookAPiKey:getEnvOrError('DODO_WEBHOOK_KEY'),
  };
